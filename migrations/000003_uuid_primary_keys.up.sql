-- Drop all constraints referencing integer PKs first
...
-- Carry UUID across to referencing tables
...
-- Restore FK from role_permissions → permissions via (resource, action)
